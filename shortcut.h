			...
			if(text[i] == '$'){
				...
				case 'F':{									// FUNCTION KEYS
					...
					switch(number){
						...
						case 10: Keyboard.press(KEY_F10); break;
						case 11: Keyboard.press(KEY_F11); break;
						case 12: Keyboard.press(KEY_F12); break;
						case 13: Keyboard.press(KEY_F13); break;
						case 14: Keyboard.press(KEY_F14); break;
						case 15: Keyboard.press(KEY_F15); break;
						case 16: Keyboard.press(KEY_F16); break;
						case 17: Keyboard.press(KEY_F17); break;
						case 18: Keyboard.press(KEY_F18); break;
						case 19: Keyboard.press(KEY_F19); break;
						case 20: Keyboard.press(KEY_F20); break;
						case 21: Keyboard.press(KEY_F21); break;
						case 22: Keyboard.press(KEY_F22); break;
						case 23: Keyboard.press(KEY_F23); break;
						case 24: Keyboard.press(KEY_F24); break;
					}
					delay(10);
					switch(number){
						...
						case 13: Keyboard.release(KEY_F13); break;
						case 14: Keyboard.release(KEY_F14); break;
						case 15: Keyboard.release(KEY_F15); break;
						case 16: Keyboard.release(KEY_F16); break;
						case 17: Keyboard.release(KEY_F17); break;
						case 18: Keyboard.release(KEY_F18); break;
						case 19: Keyboard.release(KEY_F19); break;
						case 20: Keyboard.release(KEY_F20); break;
						case 21: Keyboard.release(KEY_F21); break;
						case 22: Keyboard.release(KEY_F22); break;
						case 23: Keyboard.release(KEY_F23); break;
						case 24: Keyboard.release(KEY_F24); break;
					}
					break;
				}
				case 'd':{									// DELAY in ms (syntax: $d1234$)
					int time = 0;
					for (int j = 0; j < 4; j++){
						i++;
						if(text[i] == '$'){
