...
I have stolen this piece of code - nay, artwork - from a cyborg from Colorado.
Therefore, the copyright lies by Zack Freedman, (c) 2020
...
void getFullLine(char *buffer, bool constructive)
{
  ...
  while ((constructive ? verbNumber == lastConstructiveVerbNumber : verbNumber == lastDestructiveVerbNumber) || nounNumber == lastNounNumber || verbLength + nounLength > 16)
  { // We need 4 extra chars for 'ing' and the space
